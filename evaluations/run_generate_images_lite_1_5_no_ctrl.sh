...
#SBATCH --array=0-1499 # Set the array size to cover all combinations
...
output_data_dir="/project/pi_ekalogerakis_umass_edu/dshivashok/ControlNet/evaluations/data/1_5_no_ctrl_tests"
...
object="chair"
learned_token="<chair>"
learned_token_path="/work/pi_ekalogerakis_umass_edu/pgoyal/geometry_editing/trained_embeddings/text-inversion-model-main-matching-prompts-50-512-4-6000-runwayml/stable-diffusion-v1-5"
...
python generate_images_lite_1_5_no_ctrl.py \
    --model_id "$model_id" \
