...
from cldm.ddim_hacked_periodic_1_5 import DDIMSampler
...
def generate_images(model_id, input_data, init_prompts, base_prompts, learned_token, learned_token_path, obj, seed, view, output_data_dir, num_samples, image_resolution, ddim_steps, strength, scale, eta, interval):
    ...
    second_model_sd = create_model('../models/sd_1_5_inference.yaml').cpu()
    second_model_sd.load_state_dict(load_state_dict('stable-diffusion-v1-5/v1-5-pruned-emaonly.safetensors', location='cuda')) #stable-diffusion-2-1-base/v2-1_512-ema-pruned.safetensors
