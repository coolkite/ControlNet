...
#SBATCH --array=0-1124 # Set the array size to cover all combinations (5 shapes * 6 intervals * 3 views * 8 seeds)
...
input_data_dir="/project/pi_ekalogerakis_umass_edu/dshivashok/ControlNet/evaluations/data/5test_inloop_all"
output_data_dir="/project/pi_ekalogerakis_umass_edu/dshivashok/ControlNet/evaluations/binarized_data/5test_inloop_all_output"
...
views=(0 4 8 12 16)
seeds=(021904 091222 270606 123115 170605)
...
python evaluate_images_lite_binarized.py \
