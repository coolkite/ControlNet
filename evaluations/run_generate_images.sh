...
#SBATCH --mem=15G # Request 30GB of memory
#SBATCH --array=0 # Set the array size to 100
...
output_data_dir="/project/pi_ekalogerakis_umass_edu/dshivashok/ControlNet/evaluations/data/ptest"
...
object="chair"
learned_token="<chair>"
learned_token_path="/project/pi_ekalogerakis_umass_edu/token_geometry/learned_token_embeddings/text-inversion-model-main-cosine" #"/project/pi_ekalogerakis_umass_edu/dmpetrov/data/textual_inversion_results/03001627_1006be65e7bc937e9141f9b58470d646/learned_embeds.safetensors"
...
model_ids=($(ls -1 "${learned_token_path}" | grep -E '^[0-9]+_' | sort -u))
