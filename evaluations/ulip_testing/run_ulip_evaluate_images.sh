...
input_data_dir="/project/pi_ekalogerakis_umass_edu/dshivashok/ControlNet/evaluations/ulip_testing/data/test1"
output_data_dir="/project/pi_ekalogerakis_umass_edu/dshivashok/ControlNet/evaluations/ulip_testing/data/test1_output"
...
python ulip_evaluate_images.py \
